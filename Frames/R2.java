...
public class R2	extends JFrame implements ActionListener 
{
    ...
    public R2()
	{
        ...
        // --- Item 1: Chicken Pizza ---
        itemLbl1 = new JLabel("Chicken Pizza");
        itemLbl1.setBounds(100, 120, 200, 30);
        itemLbl1.setFont(new Font("Cambria", Font.PLAIN, 18));
        panelA.add(itemLbl1);
        
        priceLbl1 = new JLabel("Tk. " + pricePChicken);
        ...
        priceLbl2 = new JLabel("Tk. " + pricePBeef);
    ...
    private void placeOrder()
	{
        try {
            ...
            if(qty1 > 0) {
                itemNames.add("Chicken Pizza");
                itemPrices.add(pricePChicken);
                itemQuantities.add(qty1);
                grandTotal += qty1 * pricePChicken;
            }
            
            // Add Beef Burger if quantity > 0
            if(qty2 > 0) {
                itemNames.add("Beef Pizza");
                itemPrices.add(pricePBeef);
                itemQuantities.add(qty2);
                grandTotal += qty2 * pricePBeef;
            }
